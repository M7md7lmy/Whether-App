...
// API : ` https://api.weatherapi.com/v1/forecast.json?key=71dbd040c45b418aa92175158231802&q=cairo&days=3 `
...
function displayNextData(data) {
  let forecastData = data.forecast.forecastday; // it's only summary
